      ...
      <form id="pacienteForm" method="POST">
        ...
        <div class="modal-body" style="max-height: 600px; overflow-y: auto;">
          ...
          <div class="form-row pt-4">
            ...
            <h3 class="text-center mt-2"><strong> Datos Familiares </strong></h3>
            <h4 class="text-center mt-2"><strong> Datos de la madre </strong></h4>
            ...
            <h4 class="text-center mt-2"><strong> Datos del Padre </strong></h4>
            ...
            <div class="form-row pt-4">
              ...
              <div class="form-group col-sm-12 col-md-4 col-xl-4">
                <label for="vivep">Vive Padre:</label>
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-outline-success btn-lg"><i class="fas fa-save"></i> Ingresar<span
                id=""></span></button>
          </div>
        </div>
      </form>
