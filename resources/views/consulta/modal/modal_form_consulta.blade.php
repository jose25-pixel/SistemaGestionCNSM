        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-6">
                ...
                <div class="input-group is-invalid">
                  <div class="input-group-prepend">
                    <label class="input-group-text" for="paciente" onclick="openModalPacientes()"><i style="cursor: pointer" class="fas fa-plus"></i></label>
                  </div>
                  <input class="custom-select" name="paciente" id="paciente" readonly required>
                </div>
              </div>
            ...
            <div class="form-group col-sm-12 col-md-6 col-xl-6">
              ...
              <input id="genograma" name="genograma" class="form-control clear-input">
            </div>
            <div class="form-group col-sm-12 col-md-6 col-xl-6">
